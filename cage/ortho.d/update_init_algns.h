...
void write_init_maf(FILE *output_f, struct DotList *init_algns, int num_algns, char *sp1_name, char *sp2_name, int len1, int len2, FILE *fp, int flag, char *species, char *speices2);
