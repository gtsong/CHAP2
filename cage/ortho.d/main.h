...
#define INC_CONV 6 // including conversions
...
#define DIS_THRESHOLD 2500 // Threshold to simplify the dot plot by merging
...
struct DotList{
  ...
  int sign; // if the sign is 0, the orientation is the same
	...
	int indiv_fid; // ith alignment of the initial individual dot plot
