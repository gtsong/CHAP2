...
void limit_position_table
   (postable*	pt,
	...
	maxChasm /= pt->step;		// (convert maxChasm to step realm)
...
//   criterion.  The algorithm used is similar to Berensham's line drawing
...
static void breakup_chasm
   (char*	protected,
	...
	unspos	maxChasm)
	{
	unspos	pos, len, numer, denom, markNum;

// $$$ check this to see if I need to worry about overflow
