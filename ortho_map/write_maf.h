...
void write_maf(char *fname, struct DotList *algns, int num_algns, struct r_list *rp1, struct r_list *rp2, char *sp1_name, char *sp2_name, int len1, int len2, FILE *fp);
